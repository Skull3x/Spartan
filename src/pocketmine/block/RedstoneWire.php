                                ...
                                foreach($sides as $s) {
                                        if($s != $this->getOppositeSide($side[0])) {
                                                ...
                                                if(($e instanceof Door) or ( $e instanceof Trapdoor) or ( $e instanceof FenceGate)) {
                                                        if(!$e->isOpened())
                                                                $e->onActivate(new Item(0));
                                                }
                                                if($e->getId() == Block::TNT)
                                                        $e->onActivate(new Item(Item::FLINT_AND_STEEL));
                                                /** @var ActiveRedstoneLamp $e */
                                                if($e->getId() == Block::INACTIVE_REDSTONE_LAMP)
                                                        $e->turnOn();
                                        }
                                }
                        }
                                ...
                                foreach($sides as $s) {
                                        if($s != $this->getOppositeSide($side[0])) {
                                                ...
                                                if(!$this->checkPower($e)) {
                                                        ...
                                                        /** @var ActiveRedstoneLamp $e */
                                                        if($e->getId() == Block::ACTIVE_REDSTONE_LAMP)
                                                                $e->turnOff();
                                                }
                                        }
                                }
